...
def list_authenticated_providers(
    ...
    for pid, overlay in HERMES_OVERLAYS.items():
        ...
        if hermes_slug in {"openai-codex", "copilot", "copilot-acp", "auggie-acp", "augment-rest"}:
            ...
            # is safe for unauthenticated and offline cases too. The same
            # pathway is used for the local auggie-acp + augment-rest
            # providers so their curated catalogs show up in /model.
