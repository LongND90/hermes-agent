...
_VALID_API_MODES = {
    ...
    "anthropic_messages",
    "bedrock_converse",
    # Direct HTTP transport to Augment's /chat-stream endpoint (augment-rest
    # provider). Bypasses OpenAI/Anthropic SDKs for streaming SSE responses.
    "augment_rest",
...
def resolve_runtime_provider(
    *,
    ...
    if provider in {"copilot-acp", "auggie-acp"}:
