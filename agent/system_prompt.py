...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Gateway tool-first guidance — append for non-CLI/cron platforms so
    # remote messaging surfaces (telegram, discord, slack, …) prefer tool
    # calls over chat narration.
    if platform_key not in _NON_GATEWAY_PLATFORMS:
        stable_parts.append(GATEWAY_TOOL_FIRST_GUIDANCE)
